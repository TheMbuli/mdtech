...
class Formation(models.Model):
    ...
    prix_pro = models.PositiveIntegerField(help_text="Prix pro",blank=True, null=True)
    prix_etudiant = models.PositiveBigIntegerField(help_text="Prix étudiant", blank=True, null=True)
